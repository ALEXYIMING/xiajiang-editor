...
'wechat-medium': {
  ...
  'mdnice-standard': {
    name: '✨ mdnice 标准',
    styles: {
      container: 'max-width: 680px; margin: 0 auto; padding: 0 10px; font-family: Optima-Regular, PingFangSC-light, "PingFang SC", Cambria, Georgia, serif; font-size: 16px; line-height: 1.6; color: black; word-break: break-word;',
      h1: 'font-size: 24px; font-weight: bold; color: black; margin-top: 30px; margin-bottom: 15px; padding: 0px;',
      h2: 'font-size: 22px; font-weight: bold; color: black; margin-top: 30px; margin-bottom: 15px; padding: 0px;',
      h3: 'font-size: 20px; font-weight: bold; color: black; margin-top: 30px; margin-bottom: 15px; padding: 0px;',
      h4: 'font-size: 18px; font-weight: bold; color: black; margin-top: 30px; margin-bottom: 15px; padding: 0px;',
      h5: 'font-size: 16px; font-weight: bold; color: black; margin-top: 30px; margin-bottom: 15px; padding: 0px;',
      h6: 'font-size: 16px; font-weight: bold; color: black; margin-top: 30px; margin-bottom: 15px; padding: 0px;',
      ...
      blockquote: 'border: none; border-left: 3px solid rgba(0, 0, 0, 0.4); background: rgba(0, 0, 0, 0.05); color: #6a737d; padding: 10px 20px; margin: 20px 0;',
      code: 'font-size: 14px; word-wrap: break-word; padding: 2px 4px; border-radius: 4px; margin: 0 2px; color: #1e6bb8; background-color: rgba(27,31,35,.05); font-family: Operator Mono, Consolas, Monaco, Menlo, monospace; word-break: break-all;',
      pre: 'margin-top: 10px; margin-bottom: 10px; padding: 16px; background-color: #2d2d2d; border-radius: 8px; overflow-x: auto;',
      hr: 'height: 1px; margin: 0; margin-top: 10px; margin-bottom: 10px; border: none; border-top: 1px solid black;',
      img: 'display: block; margin: 0 auto; max-width: 100%; max-height: 500px;',
      table: 'display: table; text-align: left; width: 100%; margin: 20px 0; border-collapse: collapse;',
      th: 'font-size: 16px; border: 1px solid #ccc; padding: 5px 10px; text-align: left; font-weight: bold; background-color: #f0f0f0;',
      td: 'font-size: 16px; border: 1px solid #ccc; padding: 5px 10px; text-align: left;',
      tr: 'border: 0; border-top: 1px solid #ccc; background-color: white;',
    }
  },
  ...
  'zhihu-style': {
    name: '✨ 知乎风格',
    styles: {
      container: 'max-width: 700px; margin: 0 auto; padding: 16px 12px 40px 12px; font-family: -apple-system, BlinkMacSystemFont, "PingFang SC", "Microsoft YaHei", sans-serif; font-size: 16px; line-height: 1.8 !important; color: #1a1a1a !important; background-color: #fff !important; word-wrap: break-word;',
      h1: 'font-size: 26px; font-weight: 700; color: #1a1a1a !important; line-height: 1.4 !important; margin: 32px 0 16px; padding-bottom: 8px; border-bottom: 2px solid #0066cc;',
      h2: 'font-size: 22px; font-weight: 600; color: #1a1a1a !important; line-height: 1.4 !important; margin: 28px 0 14px; padding-left: 12px; border-left: 4px solid #0066cc;',
      h3: 'font-size: 19px; font-weight: 600; color: #333 !important; line-height: 1.5 !important; margin: 24px 0 12px;',
      h4: 'font-size: 17px; font-weight: 600; color: #444 !important; line-height: 1.5 !important; margin: 20px 0 10px;',
      h5: 'font-size: 16px; font-weight: 600; color: #555 !important; line-height: 1.5 !important; margin: 18px 0 9px;',
      ...
      ol: 'margin: 16px 0; padding-left: 24px;',
      li: 'margin: 8px 0; line-height: 1.8 !important; color: #1a1a1a !important;',
      blockquote: 'margin: 16px 0; padding: 8px 16px; background-color: #f5f8ff !important; border-left: 3px solid #0066cc; color: #555 !important; line-height: 1.6 !important;',
      code: 'font-family: Consolas, Monaco, "Courier New", monospace; font-size: 14px; padding: 2px 6px; background-color: #f5f5f5 !important; color: #e74c3c !important; border-radius: 3px;',
      pre: 'margin: 20px 0; padding: 16px; background-color: #2d2d2d !important; border-radius: 8px; overflow-x: auto; line-height: 1.5 !important;',
      hr: 'margin: 32px 0; border: none; border-top: 1px solid #e0e0e0;',
      img: 'max-width: 100%; max-height: 500px !important; height: auto; display: block; margin: 20px auto; border-radius: 6px;',
      table: 'width: 100%; margin: 20px 0; border-collapse: collapse; font-size: 15px;',
      th: 'background-color: #f5f8ff !important; padding: 10px; text-align: left; border: 1px solid #e0e0e0; font-weight: 600; color: #1a1a1a !important;',
